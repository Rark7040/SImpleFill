...
詳しい使用方法は以下の動画を参照してください<br>

[youtube link](https://youtu.be/E-6aQ4tCY0g)<br>

## Command
実行権限はすべてOP以上となっております<br>
...
｜ 設定項目 | 値 | 説明 |
|---|---|---|
| UseType | <truefalse> | Tapをtrueにするとアイテムをもって右クリックで、  スニークだとアイテムをもってスニークでFillモードを切り替え |
